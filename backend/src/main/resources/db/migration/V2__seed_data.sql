...
(1, 'Veterinary Care', 'Comprehensive health exams, diagnostic checkups, vaccinations, and preventive healthcare by licensed veterinary doctors.', 'service_01_vet_care', TRUE, NOW()),
(2, 'Pet Food & Nutrition', 'Tailored dietary guidance, prescription diets, and balanced wellness food for every stage of your pet’s life.', 'service_02_pet_food_rabbit_bowl', TRUE, NOW()),
(3, 'Professional Grooming', 'Baths, nail trimming, styling, ear cleaning, and coat conditioning from gentle, certified grooming experts.', 'service_03_grooming_puppy_tub', TRUE, NOW()),
(4, 'Pet Pharmacy & Meds', 'Genuine prescription medicines, flea/tick preventatives, supplements, and skin treatments delivered with care.', 'service_04_pharmacy_cat_med', TRUE, NOW()),
(5, 'Toys & Enrichment', 'Durable, safe play toys, agility essentials, and mental stimulation games designed for active, happy companions.', 'service_05_toys_kittens_play', TRUE, NOW()),
(6, 'Boarding & Daycare', 'Safe, temperature-controlled, playful suites with round-the-clock supervision while you are traveling.', 'avatar_user_2', TRUE, NOW()),
(7, 'Pet Training & Behaviour', 'Positive-reinforcement puppy manners, obedience classes, and behavioural modification by accredited trainers.', 'avatar_user_3', TRUE, NOW()),
(8, 'Pet Transport & Ambulance', 'Safe, climate-controlled door-to-door pet transport and emergency transit for appointments and relocations.', 'avatar_user_4', TRUE, NOW())
...
(1, 'Hill\'s Science Diet Adult Dry Dog Food', 'Clinically proven nutrition for optimal health and shiny coat. Formulated for adult canines with natural, high-grade chicken.', 2499.00, 'FOOD & NUTRITION', 45, 'service_02_pet_food_rabbit_bowl', TRUE, 0, NOW(), NOW()),
(2, 'Frontline Plus Flea & Tick Treatment', 'Fast-acting, long-lasting flea, tick, and chewing lice control for medium dogs (23-44 lbs). Waterproof and vet recommended.', 1299.00, 'FLEA & TICK', 80, 'service_04_pharmacy_cat_med', TRUE, 0, NOW(), NOW()),
(3, 'Royal Canin Kitten Food', 'Supports natural immune defense and digestive development for young kittens between 4 to 12 months.', 1899.00, 'FOOD & NUTRITION', 35, 'service_02_pet_food_rabbit_bowl', TRUE, 0, NOW(), NOW()),
(4, 'VetPlus Joint Care Supplement', 'Advanced joint support with Glucosamine, Chondroitin, and Omega-3 fatty acids for active and senior pets.', 1599.00, 'SUPPLEMENTS', 60, 'service_04_pharmacy_cat_med', TRUE, 0, NOW(), NOW()),
(5, 'Virbac Epi-Otic Ear Cleaner', 'Non-irritating, soothing ear cleanser formulated to remove debris and excessive wax while inhibiting bacterial growth.', 799.00, 'GROOMING', 50, 'service_03_grooming_puppy_tub', TRUE, 0, NOW(), NOW()),
(6, 'NexGard Spectra Flea & Tick Chews', 'Monthly beef-flavored chew that protects against fleas, ticks, heartworms, and intestinal worms in dogs.', 2199.00, 'MEDICATIONS', 40, 'service_04_pharmacy_cat_med', TRUE, 0, NOW(), NOW())
