package com.pawfectly.backend.config;

import com.pawfectly.backend.security.AccessDeniedHandlerJwt;
import com.pawfectly.backend.security.AuthEntryPointJwt;
import com.pawfectly.backend.security.AuthTokenFilter;
import com.pawfectly.backend.security.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        patterns.add("https://kss-petshop-official.vercel.app");
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/pet-essentials/**").permitAll()
                        ...
                        // Customer scoped endpoints - allows CUSTOMER and ADMIN roles
